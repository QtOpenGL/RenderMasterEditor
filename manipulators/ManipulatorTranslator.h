...
class ManipulatorTranslator : public ManipulatorBase
{
	...
	void intersectMouseWithAxis(RENDER_MASTER::ICamera *pCamera, const QRect &screen, const vec2 &normalizedMousePos, const vec3 &axisWorldSpace, AXIS_EL type, const vec3& N, vec3 &worldOut, float &distance);
